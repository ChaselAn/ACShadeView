...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    twoColorView1.ac_shadeView(withColorList: [UIColor.red, UIColor.blue])
    ...
    twoColorView2.ac_shadeView(withColorList: [UIColor.red, UIColor.blue], direction: .leftToRight)
    ...
    twoColorView3.ac_shadeView(withColorList: [UIColor.red, UIColor.blue], direction: .leftTopToRightBottom)
